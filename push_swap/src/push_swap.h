...
/*   Updated: 2022/01/25 16:58:26 by sujilee          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				link_stack(t_carrier *carrier, t_stack **a, t_stack **p,
						char **arr);
void				fill_stack(t_carrier *carrier, char **av, t_stack **a,
						int size);
...
int					sort_descending(t_carrier *carrier, t_stack **a,
						t_stack **b);
void				sort_three(t_carrier *carrier, t_stack **a);
void				sort_five(t_carrier *carrier, t_stack **a,
						t_stack **b);
void				sort_many(t_carrier *carrier, t_stack **a,
						t_stack **b);
...
void				handle_one_two_b(t_carrier *carrier, t_stack **a,
						t_stack **b);
...
void				attach_unsorted(t_carrier *carrier, t_stack **a,
						t_stack **b, char c);
void				pivoting_a(t_carrier *carrier, t_stack **a, t_stack **b,
						int pivot);
void				pivoting_b(t_carrier *carrier, t_stack **a, t_stack **b,
						int pivot);
