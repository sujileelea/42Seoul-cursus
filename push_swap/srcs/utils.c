...
/*   Updated: 2022/01/28 11:43:56 by sujilee          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (c == 'a')
		curr->data = carrier->rra_cnt;
	else
		curr->data = carrier->rrb_cnt;
	if (c == 'a')
		curr->next = carrier->a_remnant;
	else
		curr->next = carrier->b_remnant;
	if (c == 'a')
		carrier->a_remnant = curr;
	else
		carrier->b_remnant = curr;
}
